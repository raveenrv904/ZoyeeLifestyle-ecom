    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className="text-sm md:text-base font-semibold capitalize tracking-wide text-primary border-primary border-[1px] hover:shadow-2xl transition-all duration-200 ease-in-out"
        >
