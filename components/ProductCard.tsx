    ...
    <div className="bg-gray-50 cursor-pointer w-fit transition-transform transform hover:scale-105 hover:shadow-lg hover:bg-gray-100">
      <div className="relative w-full">
        <Image
          ...
          width={250}
          height={30}
          className="object-cover w-full transition-all duration-300 hover:opacity-80 h-[370px]"
          loader={loaderProps}
        />
      ...
      <div className="space-y-1 px-3 py-1">
        <h2 className="font-semibold text-2xl">{removeExtra(title)}</h2>
        <p className="text-gray-500 tracking-wide">{category}</p>
        <div className="flex justify-between">
          <p className="font-extrabold text-xl">
            ₹ {calculateDiscountedPrice(price, discount)}
          </p>
          <p className="text-gray-400 font-extrabold line-through text-xl">
            ₹ {price}
          </p>
        </div>
